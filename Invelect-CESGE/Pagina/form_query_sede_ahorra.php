...
<body>
    <form action="">
        ...
        <h2>Formulario Consulta ahorrador</h2> <br><br>
        ...
        <div style="background-color: cornsilk;">
            <table>
                ...
                <?php
                    ...
                    $sql="SELECT sede.NOM_SEDE, lamps.NOM_LAMP AS sede_lamp, NOM_LAMP FROM sede, lamps WHERE Sede.NUM_SEDE=lamps.Sede AND (lamps.Tecno='Ahorrador')";
