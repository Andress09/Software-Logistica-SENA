...
<head>
    ...
    <title>Agregar novedades en Chillers</title>
</head>
...
<body>
    ...
    <h2>Centro de Servicios y Gestión Empresarial - Regional Antioquia.</h2>
        ...
        <h2>Formulario novedades en Chillers</h2> <br><br>
	...
	<br>
		<p>Fecha Registro:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="txtamb" value="<?= $fecha ?>"></p>
			Nombre del Chillers:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="cbxtipo" id="cbxtipo"><br>
           ...
           <?php
            ...
            while($row = $resultadosede->fetch_assoc()){
                ?>
                    <option value="<?php echo $row['NUM_CHILLERS'];?>"><?php echo $row['NOMBRE_CHIL'];?></option><?php } ?>
           </select>
		   <p>Actividad realizada: <input type="text" name="txtact"></p></p>
          <label for="cbx_sede">Estado final del Chillers:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
    ...
    $cod3=$_GET['txtobs'];
      if($piso!=null){
        $sql="INSERT INTO novechillers ( FECHACT,NOM_CHILLERS,ACT_REALI,ESTADO,OBSERVA ) VALUES ('$amb','$piso','$activit','$cod2','$cod3')";
