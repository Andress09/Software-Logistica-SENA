...
<br>
        ...
        <label for="cbx_lum">Cantidad luminarias:</label>
        &nbsp;&nbsp;<select name="cbx_lum" >
                <option value="#">Seleccionar...</option>
        ...
        &nbsp;&nbsp;&nbsp; <select name="cbx_tomas" >
				...
				<label for="cbx_caliout">Calibre salida:</label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="cbx_caliout" >
                <option value="#">Seleccionar...</option>
	...
	$lum=$_GET['cbx_lum'];
    $tom=$_GET['cbx_tomas'];
    $calsali=$_GET['cbx_caliout'];
      if($ctos!=null){
        $sql="INSERT INTO Dist_tab ( RL_CODE_TAB, Num_cto, Distri, Cant_lumin,Cant_tomas, CAL_SAL) VALUES ('$tab','$ctos','$dist','$lum','$tom','$calsali')";
