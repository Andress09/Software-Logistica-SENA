...
<?php
	...
	$resultado = mysqli_query($conn,"SELECT prestamos.COD_REG,prestamos.FECHA_ENTRE,prestamos.HORA_ENTRE,prestamos.HORA_ADDELEM,prestamos.HORA_CHANGUSU,prestamos.FECHA_DEV,prestamos.HORA_DEV,prestamos.OBS,prestamos.ESTADO,prestamos.OPER,cuentadante.ID_CUE,cuentadante.NOMBRE_CUE FROM prestamos INNER JOIN cuentadante ON prestamos.ID_USU= cuentadante.ID_CUE and  cuentadante.ID_CUE=$doc");
