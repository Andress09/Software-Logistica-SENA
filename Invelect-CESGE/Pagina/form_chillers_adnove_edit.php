...
<head>
    ...
    <title>Agregar novedad del Chillers</title>
...
error_reporting(0);
    ...
    $serie=$_GET['serie'];
    $sql="SELECT * FROM novechillers WHERE RL_CODE_CHILLERS	='".$serie."'";
...
?>
    ...
    <h2>Centro de Servicios y Gestión Empresarial - Regional Antioquia.</h2>
        ...
        <h2>Datos de la novedad del Chillers</h2></p>
    <link rel="stylesheet" href="../css/estilo_edit.css">
   ...
   <br>
         ...
         Nombre del Chillers:<input type="text" name="txtnamelamp" readonly value="<?php echo $fila['NOM_CHILLERS'] ?>"></p>
		 Actividad realizada:&nbsp;&nbsp;&nbsp;<input type="text" name="txtactreal" readonly value="<?php echo $fila['ACT_REALI'] ?>"><br>
		 Estado del Chillers:&nbsp;&nbsp;&nbsp;<input type="text" name="txtestlamp" readonly value="<?php echo $fila['ESTADO'] ?>"><br>
...
<?php
    ...
    $obs=$_GET['txtobs'];
      $user=$usuario;
            if($serie!=null){
                $sql2="UPDATE novechillers SET  OBSERVA='$obs' WHERE RL_CODE_CHILLERS='$serie'";
