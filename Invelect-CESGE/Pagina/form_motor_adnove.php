...
<head>
    ...
    <title>Agregar novedades en motor</title>
</head>
<body>
    <div>
    <h2>Centro de Servicios y Gestión Empresarial - Regional Antioquia.</h2>
        ...
        <h2>Formulario novedades en motor</h2> <br><br>
...
<br>
		<p>Fecha Registro:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="date" name="txtamb" value="<?= $fecha ?>"></p>
			Nombre del motor:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="cbxtipo" id="cbxtipo">
    ...
    $cod3=$_GET['txtobs'];
      if($piso!=null){
        $sql="INSERT INTO novemotor ( FECHACT, NUME_MOTOR, ACT_REALI, STATE, OBSERV ) VALUES ('$amb','$piso','$activit','$cod2','$cod3')";
