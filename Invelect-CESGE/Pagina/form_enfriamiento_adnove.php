...
<head>
    ...
    <title>Agregar novedades Torres enfriamiento</title>
</head>
...
<body>
    ...
    <h2>Centro de Servicios y Gestión Empresarial - Regional Antioquia.</h2>
        ...
        <h2>Formulario novedades Torres enfriamiento</h2> <br><br>
	...
	<br>
		<p>Fecha Registro:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="txtamb" value="<?= $fecha ?>"></p>
			Nombre torre enfriamiento:<select name="cbxtipo" id="cbxtipo"><br>
           ...
           <?php
            ...
            while($row = $resultadosede->fetch_assoc()){
                ?>
                    <option value="<?php echo $row['ITEM'];?>"><?php echo $row['TIPO_EQUIPO'];?></option><?php } ?>
           </select>
		   <p>Actividad realizada: <input type="text" name="txtact"></p></p>
          <label for="cbx_sede">Estado final de Torre:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
    ...
    $cod3=$_GET['txtobs'];
      if($piso!=null){
        $sql="INSERT INTO noveenfriamiento( FECHACT,TIPO_EQUIPO,ACT_REALI,ESTADO,OBSERVA ) VALUES ('$amb','$piso','$activit','$cod2','$cod3')";
