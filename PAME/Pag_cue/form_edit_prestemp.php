...
<header>
    ...
    <link rel="stylesheet" href="../css/estilo_edit.css">
        <form action=""   style=" margin-left:40%;width:900px;height: 850px;margin-top: 90px;border: 2px black solid;margin-right:20%;" autocomplete="OFF">
     
           <p>ID Usuario:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"style="opacity:40%;" name="txtid" readonly value="<?php echo $fila['ID_CUE'] ?>"></p>
           <p>Nombre Usuario: <input type="text" name="txtnom"style="opacity:40%;" readonly value="<?php echo $fila['NOMBRE_CUE'] ?>"></p>
		   ...
		   <br>
           <input type="submit" value="Actualizar" href="../Pagina/form_prestamos.php" class="btn1">
