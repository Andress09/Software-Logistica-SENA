...
<center>
        ...
        <h2>Módulo consultas de prestamos</h2>
...
<br>
<a href="../Pag_cue/form_buscar.php" style="color:waith"class="btn1 btn-success ">Retroceder</a> 
<br><br>
	...
	while($consultas = mysqli_fetch_assoc($resultado))
	  {
		...
		<table class="table table-hover">
			<tr>
			  ...
			  <th scope="col">DEV_PARCIAL</th>
			  <th scope="col">DEV_COMPLETA</th>
			...
			<tr>
			  ...
			  <td><b>'.$consultas['OPER'].'</b></td>
			  <td><a href="form_edit_devolucion_parcial.php?prestamo='.$consultas['COD_REG'].'">Dev parcial</a></td>
			  <td><a href="form_edit_devolucion.php?prestamo='.$consultas['COD_REG'].'">Dev completa</a></td>
			  <td><a href="form_edit_elem_pres.php?prestamo='.$consultas['COD_REG'].'">Adicionar elementos</a></td>
