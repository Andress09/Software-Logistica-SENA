...
?>
 ...
 <header>
        ...
        <h2>Devolución parcial de elementos</h2>
        <img src="../Imgs/empleo.png" class="imgempleo" style="float: rigth; margin-left: 70%;padding-top:50px;">
    </header>
    <body  class="fondoInde" style=" background-image: url('../Imgs/fondo1.jpeg');  background-position: center center;
    background-attachment: fixed;  background-size: cover;">
    <div>
    <form action=""   style=" margin-left:40%;width:500px;height: 600px;margin-top: 90px;border: 2px black solid;" autocomplete="OFF">

           <p>Número Préstamo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txtnump"style="opacity:40%;" readonly value="<?php echo $fila['COD_REG'] ?>"><br> Estado:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="txtestado" style="opacity:40%;"readonly value="<?php echo $fila['ESTADO'] ?>"></p>
	...
	$user=$usuario;
        ...
        if($resultado10){
           echo '<script language="javascript">alert("Elementos borrados  con exito");</script>';
			  // echo 'insert';        
