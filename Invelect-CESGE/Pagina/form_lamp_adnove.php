...
<head>
    ...
    <title>Agregar novedades en luminarias</title>
</head>
<body>
    <div>
    <h2>Centro de Servicios y Gestión Empresarial - Regional Antioquia.</h2>
        ...
        <h2>Formulario novedades luminarias</h2> <br><br>
		...
		<p>Fecha Registro:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="txtamb" value="<?= $fecha ?>"></p>
			Nombre de la Luminaria:<select name="cbxtipo" id="cbxtipo">
           ...
           <?php
            ...
            while($row = $resultadosede->fetch_assoc()){
                ?>
                    <option value="<?php echo $row['ITEM'];?>"><?php echo $row['NOM_LAMP'];?></option><?php } ?>
           </select>
		   <p>Actividad realizada:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txtact"></p></p>
          <label for="cbx_sede">Estado final de la luminaria</label>
    ...
    $cod3=$_GET['txtobs'];
      if($piso!=null){
        $sql="INSERT INTO novelamp ( FECHACT, NUME_LAMP, ACT_REALI, STATE, OBSERV ) VALUES ('$amb','$piso','$activit','$cod2','$cod3')";
