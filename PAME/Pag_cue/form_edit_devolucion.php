...
?>
  ...
  <title>Devolucion completa</title>
<header>
 ...
 <link rel="stylesheet" href="../css/estilo_edit.css">
    <div>
    <form action=""   style=" margin-left:40%;width:500px;height: 900px;margin-top: 90px;border: 2px black solid;" autocomplete="OFF">
           <p>Número Préstamo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txtnump" style="opacity:40%;"readonly value="<?php echo $fila['COD_REG'] ?>"><br> 
           ...
           <p>Fecha del préstamo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txtfechent" style="opacity:40%;"readonly value="<?php echo $fila['FECHA_ENTRE'] ?>"><br> 
		   Hora del préstamo: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txthorent" style="opacity:40%;"readonly value="<?php echo $fila['HORA_ENTRE'] ?>"><br>
           <p>Hora de adición: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txtadd" style="opacity:40%;"readonly value="<?php echo $fila['HORA_ADDELEM'] ?>"><br> 
		   Hora devolución parcial: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txtdevpar" style="opacity:40%;"readonly value="<?php echo $fila['HORA_DEVTEMP'] ?>"><br>
           Hora de cambio de usuario:<input type="text" name="txtcamus" style="opacity:40%;"readonly value="<?php echo $fila['HORA_CHANGUSU'] ?>"><br>
		   <p>Fecha devolución: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txtfedev" style="opacity:40%;"readonly value="<?php echo $fila['FECHA_DEV'] ?>"><br>
    ...
    and $state7 !='Prestado' and $state8 !='Prestado' and $state9 !='Prestado'){
    $sql="INSERT INTO historico (ID_USU, FECHA_ENTRE, HORA_ENTRE, HORA_ADDELEM, HORA_DEVTEMP, HORA_CHANGUSU, FECHA_DEV, HORA_DEV, OBS,	ELEM_, DEV_ELEM, ELEM_1, DEV_ELEM1, 
