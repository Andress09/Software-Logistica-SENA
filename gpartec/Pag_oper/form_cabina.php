...
<head>
    ...
    <title>Cabina se sonido</title>
</head>
<body>
    <form action="">
        <h2>Formulario Cabinas de sonido</h2> <br><br>
            ...
            <table>
                <tr>
                    <?php
                        ...
                        $sql="SELECT NUM_SERIE,MODELO,CARACTERISTICAS,MARCA,NUM_PLACA_SENA,TIPO_EQUIPO,NOMBRE_CUE,NOM_AMBIENTE,NOM_SEDE FROM CUENTADANTE INNER JOIN EQUIPO ON ID_CUE=RL_ID_CUE INNER JOIN AMBIENTE ON ITEM=RL_COD_AMB INNER JOIN SEDE ON NUM_SEDE=RL_COD_SEDE WHERE TIPO_EQUIPO='CABINA DE SONIDO'";
