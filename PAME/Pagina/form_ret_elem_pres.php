...
<body class="fondoInde" style=" background-image: url('../Imgs/fondo1.jpeg');  background-position: center center;
    ...
    <form action="">
        <h2>Formulario retirar de elementos del préstamo</h2> <br><br>
                ...
                <table>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                            <a href="form_edit_devolucion_parcial.php?prestamo=<?php echo $row['COD_REG'] ?>">Retirar elementos</a>
