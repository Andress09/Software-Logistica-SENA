...
<?php
	...
	$resultado = mysqli_query($conn,"SELECT * FROM historico INNER JOIN cuentadante ON ID_USU= ID_CUE WHERE FECHA_ENTRE='$cod' AND ID_USU='$cod1' OR ELEM_= '$cod' OR ELEM_1= '$cod'  OR ELEM_2= '$cod'  OR ELEM_3= '$cod'  OR ELEM_4= '$cod'  OR ELEM_5= '$cod'  OR ELEM_6= '$cod'  OR ELEM_7= '$cod'  OR ELEM_8= '$cod'  OR ELEM_9= '$cod' ");
	while($consultas = mysqli_fetch_assoc($resultado))

	if(isset($_POST['cbx_fech']) !=null && (isset($_POST['cbx_nom']))!=null){
	{
