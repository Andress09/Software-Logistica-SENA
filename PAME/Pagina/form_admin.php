            ...
            <nav>
                <ul>
                    <li><a href="Mn_pc_adm.php"> &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Inicio</a></li>
                        ...
                        <div>
                            <ul>
                            <li><a href="form_add_usu.php">Usuarios</a></li>
                            <li><a href="form_add_coord.php">Coordinadores</a></li>
                            <li><a href="form_cuentadante.php">Operadores</a></li>
                            </ul>                          
                        </div>
                    </li>
                            <li><a href="form_add_sede.php"> &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Sedes</a></li>
                            <li><a href="form_add_ambiente.php"> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Ambientes</a></li>
                            <li><a href="form_add_elem.php">  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;Elementos</a></li>
