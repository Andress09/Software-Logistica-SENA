...
<body>
    ...
    <h2>Centro de Servicios y Gestión Empresarial - Regional Antioquia.</h2>
        ...
        <h2>Formulario novedades en las UMAS</h2> <br><br>
...
<br>
		<p>Fecha Registro:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="date" name="txtamb" value="<?= $fecha ?>"></p>
			Nombre de UMAS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="cbxtipo" id="cbxtipo">
           ...
           <?php
            ...
            while($row = $resultadosede->fetch_assoc()){
                ?>
                    <option value="<?php echo $row['ITEM'];?>"><?php echo $row['NOMBRE'];?></option><?php } ?>
           </select>
		   <p>Actividad realizada: <input type="text" name="txtact"></p></p>
          <label for="cbx_sede">Estado del motor:</label>
    ...
    $cod3=$_GET['txtobs'];
      if($piso!=null){
        $sql="INSERT INTO noveumas (FECHACT,NOMBRE,ACT_REALI,STATE,OBSERV ) VALUES ('$amb','$piso','$activit','$cod2','$cod3')";
