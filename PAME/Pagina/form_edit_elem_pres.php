...
background-attachment: fixed;  background-size: cover;">
 ...
 <h2>Adicionar elementos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h2>
    <div>
        <form action=""   style="border:2px black solid;margin: 3%;margin-left: 30%;margin-right: 25%;"  autocomplete="OFF">
    
           <p>Número Préstamo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"style="opacity:40%;" name="txtnump" readonly value="<?php echo $fila['COD_REG'] ?>"><br>
           Estado:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="opacity:40%;"name="txtestado" readonly value="<?php echo $fila['ESTADO'] ?>"></p>
		   <p>Número de documento: <input type="text" style="opacity:40%;"name="txtid" readonly value="<?php echo $fila['ID_USU'] ?>"><br> Nombre Usuario:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="opacity:40%;"name="txtnuma" readonly value="<?php echo $fila['NOMBRE_CUE'] ?>"> <br> <br>
